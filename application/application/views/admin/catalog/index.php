                        ...
                        <table id="data-table" class="table table-bordered table-striped" style="width: 100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>ID</th>
                                    <th nowrap><?php echo lang('name-catalog');?></th>
                                    <th nowrap><?php echo lang('parents_id');?></th>
                            ...
                            <div class="box-body">
                                <div class="col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <label><?php echo lang('from_child');?></label>
                                        <input type="text" name="child" class="form-control" placeholder="Nhập tên danh mục con !">
                                    </div>
                                    <div class="form-group">
                                        <label><?php echo lang('form_catalog_parend');?></label>
                                ...
                                <div class="col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <label><?php echo lang('form_parend');?></label>
                                        <input type="text" name="parent" class="form-control" placeholder="Nhập tên danh mục cha !">
                                    </div>
                                </div>
                            </div>
                        </div>
