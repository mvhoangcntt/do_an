                    ...
                    <form action="" id="form-table" method="post">
                        ...
                        <table id="data-table" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th nowrap><?php echo lang('text_news_featured');?></th>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab_info">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label><?php echo lang('form_internal');?></label>
                                    <select class="form-control select2 filter_catalog" title="filter_catalog_id" name="category_id" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                    </select>
                                </div>
                            </div>
                        </div>
