...
<section class="page-news page-primary">
    <div class="container">
        <ul class="link-page">
            <li class="active"><a href="<?php echo base_url('news/all'); ?>" title="<?php echo lang('text_news_all');?>"><?php echo lang('text_news_all');?></a></li>
        ...
        <div class="list-news">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="item-news item-news1">
                        ...
                        <div class="ct">
                            <span class="time1"><?php echo date("d.m.Y",strtotime($item['created_time'])); ?></span>
