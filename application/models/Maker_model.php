...
class Maker_model extends APS_Model
{
   public function __construct()
   {
      parent::__construct();
      $this->table          = "maker";
      $this->column_order  = array("$this->table.id","$this->table.id","$this->table.name_maker","$this->table.content","$this->table.created","$this->table.created_time"); //thiết lập cột sắp xếp
      $this->column_search = array("$this->table.id","$this->table.name_maker","$this->table.content","$this->table.created","$this->table.created_time"); //thiết lập cột search
   }
